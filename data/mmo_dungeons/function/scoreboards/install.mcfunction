#
scoreboard objectives add dungeon_spawn_room dummy
scoreboard objectives add dungeon_spawn_type dummy
scoreboard objectives add dungeon_total_entities dummy
