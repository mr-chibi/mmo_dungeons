...
execute as @s[tag=mmo_dungeon_key] as @e[type=minecraft:marker,tag=desert_treasure_room_2,distance=0..1,limit=1,tag=!dungeon_door] at @s run tag @s[tag=!dungeon_door] add dungeon_door
execute as @s[tag=mmo_dungeon_key] as @e[type=minecraft:marker,tag=desert_puzzle_room_1,distance=0..1,limit=1,tag=!dungeon_door] at @s run tag @s[tag=!dungeon_door] add dungeon_door
execute as @s[tag=mmo_dungeon_key] as @e[type=minecraft:marker,tag=desert_resting_room,distance=0..1,limit=1,tag=!dungeon_door] at @s run tag @s[tag=!dungeon_door] add dungeon_door

# Remove Key:
execute as @s[tag=mmo_dungeon_key] if entity @e[type=minecraft:marker,tag=desert_treasure_room_2,distance=0..1,limit=1,tag=dungeon_door] run clear @s minecraft:iron_nugget[minecraft:custom_data={Tags:["dungeon_key"]}] 1
execute as @s[tag=mmo_dungeon_key] if entity @e[type=minecraft:marker,tag=desert_puzzle_room_1,distance=0..1,limit=1,tag=dungeon_door] run clear @s minecraft:iron_nugget[minecraft:custom_data={Tags:["dungeon_key"]}] 1
execute as @s[tag=mmo_dungeon_key] if entity @e[type=minecraft:marker,tag=desert_resting_room,distance=0..1,limit=1,tag=dungeon_door] run clear @s minecraft:iron_nugget[minecraft:custom_data={Tags:["dungeon_key"]}] 1
