...
#
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_enterance,distance=0..2,limit=1,scores={dungeon_spawn_room=1}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/enterance
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_trap_hallway,distance=0..2,limit=1,scores={dungeon_spawn_room=2}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/trap_hallway
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_treasure_room_1,distance=0..2,limit=1,scores={dungeon_spawn_room=3}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/treasure_room_1
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_catacombs_1,distance=0..2,limit=1,scores={dungeon_spawn_room=4}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/catacombs_1
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_separator_1,distance=0..2,limit=1,scores={dungeon_spawn_room=5}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/separator_1

# Door Entity:
function mmo_dungeons:generate/desert/entities/locks

#
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_catacombs_2,distance=0..2,limit=1,scores={dungeon_spawn_room=9}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/catacombs_2
execute as @e[type=minecraft:marker,tag=mmo_dungeon,tag=desert_boss_chamber,distance=0..1,limit=1,scores={dungeon_spawn_room=10}] at @s as @p[distance=0..1] at @s run function mmo_dungeons:generate/desert/boss_chamber
